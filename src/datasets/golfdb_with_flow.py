...
class GolfDBwithFlow(VideoDataset):
    def __init__(
        self,
        root_dir: str,
        annotation_file: str,
    ...
    def __getitem__(self, idx: int) -> Dict[str, Any]:
        ...
        flow_path = os.path.join(self.root_dir, "../flows_160", "{}.mp4".format(self.df.loc[idx, "id"]))
        ...
        flows = self._get_frames_from_video(flow_path, start_frame, end_frame)
...
def get_dataset(config: Dict, split: str, transform: Optional[transforms.Compose]) -> GolfDBwithFlow:
    """
    Args:
